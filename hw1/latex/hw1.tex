...
Likewise, the variance can be calculated.

$$ \sigma_n^2 = \sum_{-\infty}^{\infty} r^2 (1-r)^{n} V_o[n]^2 * PDF(V_o[n]) = \sigma_o^2 * \sum_{0}^{\infty} r^2 (1-r)^n = r \sigma_o^2$$

Also, from the properties of the autocorrelation function, we know that $E[V_n]^2 = R_X(0)$.
